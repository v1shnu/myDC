...
class theme():
	...
	def __init__(self): # Header images + Menu
...
<div id="header_wrapper">
	...
	def __del__(self): # Complete Sidebar + Footer 
		print '''
...
$(document).ready(function(){
	...
	<div class="sidebar_box">
		<h4>Links</h4>
		<ul class="tmo_list">'''
		if dchub.mydc.auth(5): print "<li><a href=\"?display=adminconsole\">Admin Console</a></li><li><a href=\"?display=motd\">MOTD Editor</a></li>"
...
'''
	...
	def index(self): # Home page with Search Box + Latest Content
		print '''
...
<div id="main_wrapper">
	...
	def register(self): # Rules + Registration Form
		print '''
...
<div id="main_wrapper">
	...
	def adminconsole(self):
		if not dchub.mydc.auth(5):
			print """
			<meta HTTP-EQUIV="REFRESH" content="0; url=./mydc.py">
			<title>Access Denied</title>
			</div> <!-- end of header -->
			</div> <!-- end of header wrapper -->
			<div id="main_wrapper"><div id="main">
			<div id="content"><h4>Access Denied!</h4></div>
			"""
			return
		print '''
...
<div id="main_wrapper">
	<div id="main">
    	...
    	<div id="content" style='font-size: 14px;'>
		<h4>MOTD Editor</h4>
		<form action='?action=motd_update_notice' method="post">
		<br><textarea name="notice" class="field" style="width: 690px; height: 400px;">'''
		f=open("./motd")
		print f.read()
		print '''
		</textarea>
		<br>		
		<div align="center"><input type="submit" class="submit_btn" style='font-weight:bold;' value="Apply Changes"></div>
		</form>
		</div>
'''
